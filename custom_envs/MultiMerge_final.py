...
class BSM_Noise_No_Image(BsmMergeAllRewards):
    def getObservations(self):
        ...
        if vehicle_ids:
            ...
            state_speed = state_speed + np.random.normal(0.277778,1,np.size(state_position_x)) * self.noise_level
            state_position_x = state_position_x + np.random.normal(1.5,1, np.size(state_position_x))* self.noise_level
            state_position_y = state_position_y + np.random.normal(1.5,1, np.size(state_position_x))* self.noise_level
            state_acc = state_acc + np.random.normal(0.3,1, np.size(state_position_x))
            
            state_latSpeed =  state_latSpeed + np.random.normal(0.277778,1, np.size(state_position_x))* self.noise_level
        state = {
            'xPos': np.array(state_position_x, dtype=np.float32),
            'yPos': np.array(state_position_y, dtype=np.float32),
            'velocity': np.array(state_speed, dtype=np.float32),
...
class Image_Noise_No_BSM(BsmMergeAllRewards):
    def getObservations(self):
        ...
        sigmavalue = np.random.uniform(0,1) * self.noise_level
...
class BSM_Noise_Perfect_Image(BsmMergeAllRewards):
    def getObservations(self):
        ...
        state_position_y = state_position_y + np.random.normal( 1, 1.5,np.size(state_position_x)) * self.noise_level
...
class BSM_Perfect_Noise_Image(BsmMergeAllRewards):
    def getObservations(self):
        ...
        sigmavalue = np.random.uniform(0,1)
        state_image = gaussian_filter(state_image, sigma=sigmavalue) * self.noise_level
