...
class SumoRamp(gym.Env):
    ...
    def __init__(self, weights=None, action_space={"high": 3, "low": -4.5},
            sumoParameters=None, isBaseline=False, obsspaces=None, render=0,sumo_seed: Union[str,int] = 'random',sumo_warnings: bool = True,net_file: str = './custom_envs/sumo_ConfigTaper/Ramp_2.net.xml', route_file :str = './custom_envs/sumo_ConfigTaper/ramp_2.rou.xml'):
