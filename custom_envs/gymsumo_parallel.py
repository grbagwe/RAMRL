...
class SumoRamp(gym.Env):
    ...
    def __init__(self, weights=None, action_space={"high": 3, "low": -4.5},
            sumoParameters=None, isBaseline=False, obsspaces=None, render=0,sumo_seed: Union[str,int] = 'random',sumo_warnings: bool = True,
                 net_file: str = './custom_envs/sumo_ConfigParallelRamp/ramp_parallel.net.xml',
        ...
        self.sumoConfigFile = "./custom_envs/sumo_ConfigParallelRamp/ramp_parallel.sumocfg"
    ...
    def sumo_reset(self):
        ...
        ##'./custom_envs//sumo_ConfigParallelRamp/ramp_parallel.net.xml',
        ## './sumo_ConfigParallelRamp/ramp_parallel.rou.xml',


        sumo_cmd = [self._sumo_binary,
                     '-n', './custom_envs/sumo_ConfigParallelRamp/ramp_parallel.net.xml',
                     '-r', './custom_envs/sumo_ConfigParallelRamp/ramp_parallel.rou.xml',
        ...
        if self.use_gui:
            ...
            if self.virtual_display is not None:
                ...
                self.disp = SmartDisplay(visible=self.env_render, size=self.virtual_display)
