...
class SumoRamp(gym.Env):
    ...
    def sumo_reset(self):
        ...
        if self.virtual_display is not None:
            ...
            self.disp = SmartDisplay(visible=self.env_render, size=self.virtual_display, backend = 'xephyr')
            self.disp.start()
    ...
    def getobservedVehicles(self, vehicle_ids):
        ...
        if "no_vehicle" in leadVehicle:
            ...
            print('leadV2', leadVehicle2)

            if leadVehicle2 in ["",None]:
                leadVehicle2 = ('no_vehicle',400)
        ...
        if "no_vehicle"  in rearVehicle:
            ...
            print('rearV2', rearVehicle2)
            if rearVehicle2 in ["", None]:
                rearVehicle2=("no_vehicle",0)
