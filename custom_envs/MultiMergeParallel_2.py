...
import traci
import numpy as np
from  custom_envs.bsmMergeParallel import BsmMerge, BsmMergeAllRewards
...
class BSM_Noise_Image_Noise(BsmMergeAllRewards):
    def getObservations(self):
        ...
        state_speed = state_speed + np.random.normal(0, 0.277778,np.size(state_position_x))* self.noise_level 

        state_position_x = state_position_x + np.random.normal(0, 1.5,np.size(state_position_x))* self.noise_level 

        state_position_y = state_position_y + np.random.normal(0, 1.5,np.size(state_position_x))* self.noise_level 

        state_acc = state_acc + np.random.normal(0, 0.3,np.size(state_position_x))* self.noise_level 


        state_latSpeed =  state_latSpeed + np.random.normal(0, 0.277778, np.size(state_position_x))* self.noise_level 
