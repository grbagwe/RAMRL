...
#            print(rearVehicle)
    ...
    def isTerminal(self):
        ...
        if self.isCollision():
            ...
            print('is collision  : ', self.stepRltime)
    ...
    def disableVehiclelaneChange(self):
        pass
        #vehicle_ids= self.getVehicleIds()
        #for vehicle not in self.rl_car_id:
        #    if traci.vehicle.getLaneID(vehicle).split('_')[1] == '1':
        #        traci.vehicle.setLane
    ...
    def addBaselineVehicle(self):
        ...
        if self.rl_car_id not in vehicle_ids:
            ...
            # # print('type_id ', traci.vehicle.getTypeID(self.rl_car_id))
            traci.vehicle.setSpeedMode(self.rl_car_id, 55)  # change speed mode to 55 which is diasble right of way
            traci.vehicle.moveTo(self.rl_car_id, laneID = 'e42_0',#traci.vehicle.getLaneID(self.rl_car_id),
                    pos = 10)
