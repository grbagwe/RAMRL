...
import gym
from custom_envs.gymsumo_parallel import SumoRamp
import traci
import numpy as np
...
class BsmMerge(SumoRamp):
    ...
    def __init__(self, weights=None, action_space={"high": 3, "low": -4.5},
                 ...
                 sumo_warnings: bool = True, net_file: str = './custom_envs/sumo_ConfigParallelRamp/ramp_parallel.net.xml',
                 route_file :str = './custom_envs/sumo_ConfigParallelRamp/ramp_parallel.rou.xml'):
...
#        print(leaddistance, ' lead distance', rearDistance,'rear Distance')
    ...
    def merge_timeReward(self):
        self.stepRltime = traci.simulation.getDeltaT()   # traci.simulation.getTime()
