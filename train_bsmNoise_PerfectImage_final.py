...
from custom_envs.MultiMerge import BSM_Noise_Perfect_Image as MultiMerge
import os
import wandb, glob
...
if __name__ == '__main__':
    run = wandb.init(
        ...
        name=f"BSMNoise+PerfectImage_{args.config}",
        dir=dir,
        config=config,
    ...
    model = PPO(config["policy_type"], env,
            verbose=3,
                ...
                n_epochs=5,
                clip_range=0.2,
                batch_size=1200, tensorboard_log=f"{dir}")
