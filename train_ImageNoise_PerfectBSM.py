...
#from custom_envs.MergeSingleBSMNoise import MultiMergeAllRewards as BSMMerge
from custom_envs.MultiMerge import BSM_Perfect_Noise_Image as MultiMerge
# from custom_envs.MergeSingleBSMNoise import MultiMergeAllRewards as BSMMerge
# from custom_envs.MergeSingleBSMNoise import MultiMergeAllRewards as BSMMerge
# from custom_envs.MergeSingleBSMNoise import MultiMergeAllRewards as BSMMerge
...
if __name__ == '__main__':
    run = wandb.init(
        ...
        name=f"ImageNoise+PerfectBSM_{args.config}",
        dir=dir,
        config=config,
